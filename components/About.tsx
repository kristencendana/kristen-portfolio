  ...
  return (
    <motion.div 
      ...
      <motion.img 
        ...
        className='-mb-20 mt-[3rem] md:mb-0 flex-shrink-0 xxs:w-40 xxs:h-40 xs:w-40 xs:h-40 short:w-56 short:h-56 w-56 h-56 
        xxs:rounded-full xs:rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[400px] xl:h-[400px] xxs:pb-0 xs:pb-0 pb-5'
      />
      <div className='px-0 md:px-10 text-center'>
        <h4 className='xxs:mt-8 xs:mt-8 xs:mb-0 xxs:text-xl xs:text-xl short:text-2xl text-4xl font-semibold'>
